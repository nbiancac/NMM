...
# Mode_vec = [250, 500, 750, 1000, 1250, 1500, 1750, 1794]
Mode_vec = [10]
Np = 50
...
for iR in Mode_vec:
    ...
    # np.savetxt('Arrays/Z_conv_imp_CST'+str(iR)+'_Np'+str(Np)+'.txt', Z_conv, fmt='%.16f%+.16fj')
    
    plt.figure()
    plt.plot(range1*1e-9, Z_conv.real)
    # plt.legend(['real', 'imag'])
    plt.title('Beam current: CST modes '+str(iR)+', fixed P = '+str(sim.index_max_p)+', Np = '+str(Np))
